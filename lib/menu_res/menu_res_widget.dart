...
class MenuResWidget extends StatefulWidget {
  const MenuResWidget({super.key});

  @override
  State<MenuResWidget> createState() => _MenuResWidgetState();
}

class _MenuResWidgetState extends State<MenuResWidget> {
  late MenuResModel _model;
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('tickets_support');
                                      },
                                      child: Container(
                                        width: double.infinity,
                                        height: 68.0,
