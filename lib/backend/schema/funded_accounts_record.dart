...
class FundedAccountsRecord extends FirestoreRecord {
  FundedAccountsRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('funded_accounts');

  static Stream<FundedAccountsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => FundedAccountsRecord.fromSnapshot(s));

  static Future<FundedAccountsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => FundedAccountsRecord.fromSnapshot(s));

  static FundedAccountsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      FundedAccountsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static FundedAccountsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      FundedAccountsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'FundedAccountsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is FundedAccountsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createFundedAccountsRecordData({
  String? idAccount,
  String? plataforma,
  String? status,
  String? endAccount,
...
class FundedAccountsRecordDocumentEquality
    implements Equality<FundedAccountsRecord> {
  const FundedAccountsRecordDocumentEquality();

  @override
  bool equals(FundedAccountsRecord? e1, FundedAccountsRecord? e2) {
  ...
  @override
  int hash(FundedAccountsRecord? e) => const ListEquality().hash([
        e?.idAccount,
        e?.plataforma,
        e?.status,
        e?.endAccount,
  ...
  @override
  bool isValidKey(Object? o) => o is FundedAccountsRecord;
}
