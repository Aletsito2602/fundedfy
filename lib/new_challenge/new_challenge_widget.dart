...
import 'new_challenge_model.dart';
export 'new_challenge_model.dart';

class NewChallengeWidget extends StatefulWidget {
  const NewChallengeWidget({super.key});

  @override
  State<NewChallengeWidget> createState() => _NewChallengeWidgetState();
}

class _NewChallengeWidgetState extends State<NewChallengeWidget>
    with TickerProviderStateMixin {
  late NewChallengeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewChallengeModel());
    ...
    _model.cuponResTextController ??= TextEditingController();
    _model.cuponResFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CuponRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CuponRecord> newChallengeCuponRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final newChallengeCuponRecord = newChallengeCuponRecordList.isNotEmpty
            ? newChallengeCuponRecordList.first
            : null;
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    5.0),
                                                        child: Text(
                                                          '1. Select your Challenge Balance',
                                                                                        ...
                                                                                        FFButtonWidget(
                                                                                          onPressed: () async {
                                                                                            context.pushNamed(
                                                                                              ...
                                                                                              queryParameters: {
                                                                                                'cupon': serializeParam(
                                                                                                  newChallengeCuponRecord?.reference,
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        if (FFAppState().CUPON ==
                                                                                            valueOrDefault<String>(
                                                                                              newChallengeCuponRecord?.cupon18,
                                                                                              '\$407.54',
                                                                                            ))
                                                                                          Padding(
                                                                                            padding: EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 0.0),
                                                                                    ...
                                                                                    child: Row(
                                                                                      ...
                                                                                      children: [
                                                                                        FFButtonWidget(
                                                                                          onPressed: () async {
                                                                                            context.pushNamed(
                                                                                              'select-balance-hft-300k',
                                                                                              queryParameters: {
                                                                                                'ref300': serializeParam(
                                                                                                  newChallengeCuponRecord?.reference,
                                                                                                  ParamType.DocumentReference,
                                                                                                ),
                                                                                              }.withoutNulls,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: TextFormField(
                                                controller: _model
                                                    .cuponResTextController,
                                                focusNode:
                                                    _model.cuponResFocusNode,
                                                autofocus: true,
                                                obscureText: false,
                                                ...
                                                validator: _model
                                                    .cuponResTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ],
