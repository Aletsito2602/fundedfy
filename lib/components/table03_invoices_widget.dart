...
import 'table03_invoices_model.dart';
export 'table03_invoices_model.dart';

class Table03InvoicesWidget extends StatefulWidget {
  const Table03InvoicesWidget({super.key});

  @override
  State<Table03InvoicesWidget> createState() => _Table03InvoicesWidgetState();
}

class _Table03InvoicesWidgetState extends State<Table03InvoicesWidget> {
  late Table03InvoicesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Table03InvoicesModel());
