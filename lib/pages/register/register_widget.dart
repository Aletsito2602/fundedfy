            ...
            body: StreamBuilder<List<UsersRecord>>(
              stream: queryUsersRecord(
                queryBuilder: (usersRecord) => usersRecord.where(
                  'uid',
                  isEqualTo: _model.referralTextController.text,
                ),
                singleRecord: true,
              ),
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: _model
                                        .referralTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                                                    ...
                                                    return SizedBox(
                                                      ...
                                                      child:
                                                        ...
                                                        onSelected:
                                                            (String selection) {
                                                          safeSetState(() =>
                                                              _model.countryCodeSelectedOption =
                                                                  selection);
                                                          FocusScope.of(context)
                                                              .unfocus();
                                                        },
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: AutoSizeText(
                                                        'I acknowledge that I am not from/or am in a country where FUNDEDFY does not provide services, that my credentials are correct and correspond to the government-issued identification.',
                                                        textAlign:
                                                            TextAlign.start,
                                                        style:
                                                            FlutterFlowTheme.of(
