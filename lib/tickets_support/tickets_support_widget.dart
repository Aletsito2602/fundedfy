...
import 'tickets_support_model.dart';
export 'tickets_support_model.dart';

class TicketsSupportWidget extends StatefulWidget {
  const TicketsSupportWidget({super.key});

  @override
  State<TicketsSupportWidget> createState() => _TicketsSupportWidgetState();
}

class _TicketsSupportWidgetState extends State<TicketsSupportWidget> {
  late TicketsSupportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TicketsSupportModel());
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              List<SupportTicketsRecord> listViewSupportTicketsRecordList = snapshot.data!;
                                                                              ...
                                                                              return ListView.builder(
                                                                                ...
                                                                                itemBuilder: (context, listViewIndex) {
                                                                                  final listViewSupportTicketsRecord = listViewSupportTicketsRecordList[listViewIndex];
                                                                                  return Padding(
                                                                                                          ...
                                                                                                          Row(
                                                                                                            ...
                                                                                                            children: [
                                                                                                              Padding(
                                                                                                                padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 10.0, 0.0),
                                                                                                                child: Text(
                                                                                                                  listViewSupportTicketsRecord.subjetSitcket.maybeHandleOverflow(maxChars: 10),
                                                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                                        fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                                                        color: Color(0xFFD4B1FF),
                                                                                                                        fontSize: 15.0,
                                                                                                          ...
                                                                                                          Row(
                                                                                                            ...
                                                                                                            children: [
                                                                                                              Padding(
                                                                                                                padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 10.0, 0.0),
                                                                                                                child: Text(
                                                                                                                  listViewSupportTicketsRecord.nameTicket,
                                                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                                        fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                                                        color: Color(0xFFD4B1FF),
                                                                                                                        fontSize: 15.0,
