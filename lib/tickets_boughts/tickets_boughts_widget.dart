...
class TicketsBoughtsWidget extends StatefulWidget {
  const TicketsBoughtsWidget({super.key});
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Row(
                                                          ...
                                                          children: [
                                                            Text(
                                                              listViewChallengesOrdersRecord
                                                                  .typeofaccount,
                                                            ...
                                                            if (listViewChallengesOrdersRecord
                                                                    .status ==
                                                                'Pending order')
                                                              FFButtonWidget(
                                                                onPressed: () {
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Row(
                                                          ...
                                                          children: [
                                                            Text(
                                                              listViewChallengueAccountsRecord
                                                                  .challengeType,
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
