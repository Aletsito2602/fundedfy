...
class SelectBalanceHft100kWidget extends StatefulWidget {
  const SelectBalanceHft100kWidget({
    super.key,
    this.ref100,
  });

  final DocumentReference? ref100;
...
class _SelectBalanceHft100kWidgetState extends State<SelectBalanceHft100kWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CuponRecord>(
      stream: CuponRecord.getDocument(widget!.ref100!),
      builder: (context, snapshot) {
        ...
        final selectBalanceHft100kCuponRecord = snapshot.data!;
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  if (FFAppState().CUPON ==
                                                      selectBalanceHft100kCuponRecord
                                                          .cupon5)
                                                    Padding(
                                                      padding:
                                                          EdgeInsetsDirectional
                                                                  ...
                                                                  await ChallengesOrdersRecord
                                                                      ...
                                                                      .set(
                                                                        ...
                                                                        referente1: valueOrDefault(
                                                                            currentUserDocument?.referente1,
                                                                            ''),
                                                                        referente2: valueOrDefault(
                                                                            currentUserDocument?.referente2,
                                                                            ''),
                                                                      ));
