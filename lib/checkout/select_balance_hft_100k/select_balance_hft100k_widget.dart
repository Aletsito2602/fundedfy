...
import 'select_balance_hft100k_model.dart';
export 'select_balance_hft100k_model.dart';

class SelectBalanceHft100kWidget extends StatefulWidget {
  const SelectBalanceHft100kWidget({super.key});

  @override
  State<SelectBalanceHft100kWidget> createState() =>
      _SelectBalanceHft100kWidgetState();
}

class _SelectBalanceHft100kWidgetState extends State<SelectBalanceHft100kWidget>
    with TickerProviderStateMixin {
  late SelectBalanceHft100kModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectBalanceHft100kModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PayoutWalletsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PayoutWalletsRecord> selectBalanceHft100kPayoutWalletsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final selectBalanceHft100kPayoutWalletsRecord =
            selectBalanceHft100kPayoutWalletsRecordList.isNotEmpty
                ? selectBalanceHft100kPayoutWalletsRecordList.first
                : null;
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              selectBalanceHft100kPayoutWalletsRecord?.hftTrcWallet,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            await Clipboard.setData(ClipboardData(text: selectBalanceHft100kPayoutWalletsRecord!.hftTrcWallet));
                                                                    ...
                                                                    children: [
                                                                      ClipRRect(
                                                                        ...
                                                                        child: Image
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            selectBalanceHft100kPayoutWalletsRecord?.hftTrcWalletQr,
                                                                    ...
                                                                    children: [
                                                                      Flexible(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              AutoSizeText(
                                                                            valueOrDefault<String>(
                                                                              selectBalanceHft100kPayoutWalletsRecord?.hftBep20Wallet,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            await Clipboard.setData(ClipboardData(text: selectBalanceHft100kPayoutWalletsRecord!.hftBep20Wallet));
                                                                            ScaffoldMessenger.of(context).showSnackBar(
                                                                              SnackBar(
                                                                                content: Text(
                                                                                  'Copied to clipboard',
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ClipRRect(
                                                                                ...
                                                                                child: Image.network(
                                                                                  valueOrDefault<String>(
                                                                                    selectBalanceHft100kPayoutWalletsRecord?.hftBep20WalletQt,
                                                                                    'https://firebasestorage.googleapis.com/v0/b/dunomic-c1930.appspot.com/o/bep20_qr.jpg?alt=media&token=b411d6d0-f76a-4c34-ad28-36effe7bfc6b',
                                                                                  ),
                                                                                  width: 159.0,
                                                                                  height: 158.0,
