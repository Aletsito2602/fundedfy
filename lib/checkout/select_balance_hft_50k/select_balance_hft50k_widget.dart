...
import 'select_balance_hft50k_model.dart';
export 'select_balance_hft50k_model.dart';

class SelectBalanceHft50kWidget extends StatefulWidget {
  const SelectBalanceHft50kWidget({super.key});

  @override
  State<SelectBalanceHft50kWidget> createState() =>
      _SelectBalanceHft50kWidgetState();
}

class _SelectBalanceHft50kWidgetState extends State<SelectBalanceHft50kWidget>
    with TickerProviderStateMixin {
  late SelectBalanceHft50kModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectBalanceHft50kModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PayoutWalletsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PayoutWalletsRecord> selectBalanceHft50kPayoutWalletsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final selectBalanceHft50kPayoutWalletsRecord =
            selectBalanceHft50kPayoutWalletsRecordList.isNotEmpty
                ? selectBalanceHft50kPayoutWalletsRecordList.first
                : null;
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              selectBalanceHft50kPayoutWalletsRecord?.hftTrcWallet,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            await Clipboard.setData(ClipboardData(text: selectBalanceHft50kPayoutWalletsRecord!.hftTrcWallet));
                                                                    ...
                                                                    children: [
                                                                      ClipRRect(
                                                                        ...
                                                                        child: Image
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            selectBalanceHft50kPayoutWalletsRecord?.hftTrcWalletQr,
                                                                    ...
                                                                    children: [
                                                                      Flexible(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              AutoSizeText(
                                                                            valueOrDefault<String>(
                                                                              selectBalanceHft50kPayoutWalletsRecord?.hftBep20Wallet,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            await Clipboard.setData(ClipboardData(text: selectBalanceHft50kPayoutWalletsRecord!.hftBep20Wallet));
                                                                            ScaffoldMessenger.of(context).showSnackBar(
                                                                              SnackBar(
                                                                                content: Text(
                                                                                  'Copied to clipboard',
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ClipRRect(
                                                                                ...
                                                                                child: Image.network(
                                                                                  valueOrDefault<String>(
                                                                                    selectBalanceHft50kPayoutWalletsRecord?.hftBep20WalletQt,
                                                                                    'https://firebasestorage.googleapis.com/v0/b/dunomic-c1930.appspot.com/o/bep20_qr.jpg?alt=media&token=b411d6d0-f76a-4c34-ad28-36effe7bfc6b',
                                                                                  ),
                                                                                  width: 159.0,
                                                                                  height: 158.0,
