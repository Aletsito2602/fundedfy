...
class SelectBalanceHft50kWidget extends StatefulWidget {
  const SelectBalanceHft50kWidget({
    super.key,
    this.ref50,
  });

  final DocumentReference? ref50;
...
class _SelectBalanceHft50kWidgetState extends State<SelectBalanceHft50kWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CuponRecord>(
      stream: CuponRecord.getDocument(widget!.ref50!),
      builder: (context, snapshot) {
        ...
        final selectBalanceHft50kCuponRecord = snapshot.data!;
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  if (FFAppState().CUPON ==
                                                      selectBalanceHft50kCuponRecord
                                                          .cupon5)
                                                    Padding(
                                                      padding:
                                                          EdgeInsetsDirectional
