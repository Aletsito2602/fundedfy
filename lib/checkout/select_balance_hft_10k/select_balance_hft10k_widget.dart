...
import 'select_balance_hft10k_model.dart';
export 'select_balance_hft10k_model.dart';

class SelectBalanceHft10kWidget extends StatefulWidget {
  const SelectBalanceHft10kWidget({super.key});

  @override
  State<SelectBalanceHft10kWidget> createState() =>
      _SelectBalanceHft10kWidgetState();
}

class _SelectBalanceHft10kWidgetState extends State<SelectBalanceHft10kWidget>
    with TickerProviderStateMixin {
  late SelectBalanceHft10kModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectBalanceHft10kModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PayoutWalletsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PayoutWalletsRecord> selectBalanceHft10kPayoutWalletsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final selectBalanceHft10kPayoutWalletsRecord =
            selectBalanceHft10kPayoutWalletsRecordList.isNotEmpty
                ? selectBalanceHft10kPayoutWalletsRecordList.first
                : null;
                                                                      ...
                                                                      children: [
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              valueOrDefault<String>(
                                                                                selectBalanceHft10kPayoutWalletsRecord?.hftTrcWallet,
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              await Clipboard.setData(ClipboardData(text: selectBalanceHft10kPayoutWalletsRecord!.hftTrcWallet));
                                                                      ...
                                                                      children: [
                                                                        ClipRRect(
                                                                          ...
                                                                          child:
                                                                              Image.network(
                                                                            valueOrDefault<String>(
                                                                              selectBalanceHft10kPayoutWalletsRecord?.hftTrcWalletQr,
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                AutoSizeText(
                                                                              valueOrDefault<String>(
                                                                                selectBalanceHft10kPayoutWalletsRecord?.hftBep20Wallet,
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              await Clipboard.setData(ClipboardData(text: selectBalanceHft10kPayoutWalletsRecord!.hftBep20Wallet));
                                                                              ScaffoldMessenger.of(context).showSnackBar(
                                                                                SnackBar(
                                                                                  content: Text(
                                                                                    'Copied to clipboard',
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ClipRRect(
                                                                                  ...
                                                                                  child: Image.network(
                                                                                    valueOrDefault<String>(
                                                                                      selectBalanceHft10kPayoutWalletsRecord?.hftBep20WalletQt,
                                                                                      'https://firebasestorage.googleapis.com/v0/b/dunomic-c1930.appspot.com/o/bep20_qr.jpg?alt=media&token=b411d6d0-f76a-4c34-ad28-36effe7bfc6b',
                                                                                    ),
                                                                                    width: 159.0,
                                                                                    height: 158.0,
                                        ...
                                        onPressed: () async {
                                          await ChallengesOrdersRecord
                                              ...
                                              .set(
                                                ...
                                                amountofaccount: '\$10.000',
                                                plattformselected: _model
                                                    .dropDownPlatformValue,
