...
import 'select_balance_hft25k_model.dart';
export 'select_balance_hft25k_model.dart';

class SelectBalanceHft25kWidget extends StatefulWidget {
  const SelectBalanceHft25kWidget({super.key});

  @override
  State<SelectBalanceHft25kWidget> createState() =>
      _SelectBalanceHft25kWidgetState();
}

class _SelectBalanceHft25kWidgetState extends State<SelectBalanceHft25kWidget>
    with TickerProviderStateMixin {
  late SelectBalanceHft25kModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectBalanceHft25kModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PayoutWalletsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PayoutWalletsRecord> selectBalanceHft25kPayoutWalletsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final selectBalanceHft25kPayoutWalletsRecord =
            selectBalanceHft25kPayoutWalletsRecordList.isNotEmpty
                ? selectBalanceHft25kPayoutWalletsRecordList.first
                : null;
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              selectBalanceHft25kPayoutWalletsRecord?.hftTrcWallet,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            await Clipboard.setData(ClipboardData(text: selectBalanceHft25kPayoutWalletsRecord!.hftTrcWallet));
                                                                    ...
                                                                    children: [
                                                                      ClipRRect(
                                                                        ...
                                                                        child: Image
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            selectBalanceHft25kPayoutWalletsRecord?.hftTrcWalletQr,
                                                                    ...
                                                                    children: [
                                                                      Flexible(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              AutoSizeText(
                                                                            valueOrDefault<String>(
                                                                              selectBalanceHft25kPayoutWalletsRecord?.hftBep20Wallet,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            await Clipboard.setData(ClipboardData(text: selectBalanceHft25kPayoutWalletsRecord!.hftBep20Wallet));
                                                                            ScaffoldMessenger.of(context).showSnackBar(
                                                                              SnackBar(
                                                                                content: Text(
                                                                                  'Copied to clipboard',
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ClipRRect(
                                                                                ...
                                                                                child: Image.network(
                                                                                  valueOrDefault<String>(
                                                                                    selectBalanceHft25kPayoutWalletsRecord?.hftBep20WalletQt,
                                                                                    'https://firebasestorage.googleapis.com/v0/b/dunomic-c1930.appspot.com/o/bep20_qr.jpg?alt=media&token=b411d6d0-f76a-4c34-ad28-36effe7bfc6b',
                                                                                  ),
                                                                                  width: 159.0,
                                                                                  height: 158.0,
