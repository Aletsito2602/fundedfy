...
class SelectBalanceHft25kWidget extends StatefulWidget {
  const SelectBalanceHft25kWidget({
    super.key,
    this.cupon,
  });

  final DocumentReference? cupon;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CuponRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final selectBalanceHft25kCuponRecord = snapshot.data!;
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    if (FFAppState().CUPON ==
                                                        selectBalanceHft25kCuponRecord
                                                            .cupon10)
                                                      Padding(
                                                        padding:
                                                            const EdgeInsetsDirectional
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: FlutterFlowDropDown<
                                                      ...
                                                      onChanged: (val) =>
                                                          safeSetState(() =>
                                                              _model.dropDownPlattformResValue =
                                                                  val),
                                                      width: 300.0,
                                                      height: 56.0,
                                                      textStyle:
